...
class Kefu extends Base
{
    ...
    public function get_list(){
        ...
        $list = Db::table($subQuery." m")
                ...
                ->where($where)
                ->field("m.user_id,u.nickname,m.content,m.read_status,m.add_time")
                ->page($page,$limit)
...
//        echo "<pre>";print_r($result);exit;
    ...
    public function detail(){
        ...
        $list = db('message')->alias('m')
                ...
                ->where($where)
                ->field("m.user_id,u.nickname user_name,m.content,m.read_status,m.add_time,m.admin_user_id,au.nickname admin_user_name")
                ->page($page,$limit)
                ->order('m.id ASC')
                ->select();
