...
class Goods extends Validate
{
    protected $rule = [
            ...
            'price' => 'require|float|between:0.01,99999999.99',//销售价格
            'distribution' => 'require|in:1,2',//参与分销
            'credits' => 'number|between:0,9999999',//积分兑换
            'status' => 'require|in:1,2',//是否上架
            'inventory' => 'number|between:0,9999999',//可用库存
            'presenter_credits' => 'number|between:0,9999999',//赠送积分
