...
class Goods extends Validate
{
    protected $rule = [
            ...
            'credits' => 'number|between:1,9999999',//积分兑换
            'status' => 'require|in:1,2',//是否上架
            'inventory' => 'number|between:1,9999999',//可用库存
            'presenter_credits' => 'number|between:1,9999999',//赠送积分
    ...
    protected $message = [
            ...
            'credits.between' => '积分兑换只能在1-9999999之间',
            'status.require' => '请选择是否上架',
            'status.in' => '是否上架数据不正确',
            'inventory.number' => '可用库存数据不正确',
            'inventory.between' => '可用库存只能在1-9999999之间',
            'presenter_credits.number' => '赠送积分数据不正确',
            'presenter_credits.between' => '赠送积分数据不正确只能在1-9999999之间',
