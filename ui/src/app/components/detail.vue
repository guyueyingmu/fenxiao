<template>
    <div class="detail">
        ...
        <div class="content minHeight200" v-show="tagActive == 0">
            <img src="static/app/demo/detail/d0.jpg">
            <img src="static/app/demo/detail/d1.jpg">
            <img src="static/app/demo/detail/d2.jpg">
            <img src="static/app/demo/detail/d3.jpg">
            <img src="static/app/demo/detail/d4.jpg">
            <img src="static/app/demo/detail/d5.jpg">
            <img src="static/app/demo/detail/d6.jpg">
        </div>
        ...
        <div class="comment-list minHeight200" v-show="tagActive == 1"  v-loading.full="loadComment">
            ...
            <div class="main" v-if="comment_list.length > 0">
                ...
                <ul class="ui-comment">
                    <li>
                        <div class="row">
                            <div class="pic"><img src="static/app/demo/avt.jpg"> </div>
                        ...
                        <div class="imgList">
                            <img src="static/app/demo/1.png">
                            <img src="static/app/demo/3.png">
                            <img src="static/app/demo/2.png">
                            <img src="static/app/demo/4.png">
                        </div>
                    </li>
                    <li>
                        <div class="row">
...
export default {
    ...
    data() {
        return {
            ...
            swiperSlides: [
                'static/app/demo/detail/2.png',
                'static/app/demo/detail/1.png',
                'static/app/demo/detail/3.png',
            ],
            tagActive: 0,
            loadComment: false,
            comment_list:[]
